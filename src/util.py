...
class Util:
    ...
    def get_environment_informations(message):
        ...
        qt_employees = int(list[1])        
        simulation_time = int(list[2])
        return patient_arrival_interval, qt_employees, simulation_time
...
class Client:        
    ...
    def validate_message(message):
        try:
            ...
            if(type(patient_arrival_interval) != int or type(qt_employees) != int or type(simulation_time) != int):
                return False
            
            if(patient_arrival_interval < 1 or qt_employees < 1 or simulation_time < 1):
                return False
